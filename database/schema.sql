...
CREATE TABLE contratos (
    ...
    plazo_unidad                        VARCHAR(20)    NOT NULL,
    ...
    tipo_precio                         VARCHAR(20)    NOT NULL DEFAULT 'mas_iva',
    forma_pago                          VARCHAR(2000)  NOT NULL DEFAULT '',
...
CREATE TABLE otrosies_contrato (
    ...
    plazo_adicional_unidad   VARCHAR(20)    NULL,
...
CREATE TABLE solicitudes_gestion_archivos (
    ...
    valor_cotizacion    DECIMAL(18,2) NULL,
    moneda_cotizacion   VARCHAR(3)   NOT NULL DEFAULT 'COP',
    requiere_anticipo   TINYINT(1)   NOT NULL DEFAULT 0,
    porcentaje_anticipo DECIMAL(5,2) NULL,
    monto_anticipo      DECIMAL(18,2) NULL,
    propuesta           TINYINT(1)   NOT NULL DEFAULT 0,
    subido_por_id       INT          NULL,
    created_at          DATETIME     NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY (id),
